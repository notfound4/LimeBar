...
MACRO(POD2MAN PODFILE MANFILE SECTION)
	...
	IF(NOT EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${PODFILE})
		MESSAGE(FATAL ERROR "Could not find pod file ${PODFILE} to generate man page")
	ENDIF(NOT EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${PODFILE})
	...
	ADD_CUSTOM_COMMAND(
		...
		${CMAKE_CURRENT_SOURCE_DIR}/${PODFILE} > ${CMAKE_CURRENT_BINARY_DIR}/${MANFILE}.${SECTION}
	)
