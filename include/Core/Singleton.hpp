...
/*!
 *\file Singleton.hpp
 *\brief File describing singleton.
 *\author Theophile Tiffet
 *\date 01/13/2014
 */
...
/*!
 *\class singleton
 *\brief The following helper classes are placeholders for a generic
 * singleton class.
 */
template <typename T>
struct singleton
...
/*!
 *\brief Give the instance of the derived class.
...
static object_type & instance()
	...
	// It is guaranteed to be created before main() begins because
	// of the next line.
	static object_type obj;

	// The following line does nothing else than force the
	// instantiation of singleton_default<T>::create_object, whose
